/* DESCRIPTION
  ...
  Some people might prefer to reason with content, some other with percentages only. It's up to you but you must keep it as a parameter
...
fun evaporator(
    ...
    while (true) {
        new_content -= new_content * evap_per_day / 100
