/* DESCRIPTION
  ...
  Luckily, Alice and Bob are able to encode the motif as a number. Can you help them to remove numbers such that their
...
//     for(i in elements){
//         if(Collections.frequency(newList, i) > maxOcurrences){ continue }
//         else{newList.add(i)}
//     }
...
//     for(i in elements){
//         emptyMap[i] = Collections.frequency(newList, i)
//             if (emptyMap[i]!! >= maxOcurrences) {
//                 continue
//             } else {
//                 newList.add(i)
//             }
